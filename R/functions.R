...
#'
#' @return histogram of metabolites
#'
...
#' @param data The lipidomics dataset
#'
#' @return a wider data frame with metabolite, value and mean
...
#' A transformation recipe to process the data
#'
#' @param data the lipidomics dataset
#' @param metabolite_variable the column of the variable
#'
#' @return data frame
...
create_model_workflow <-
    function(model_specs, recipe_specs) {
        workflows::workflow() |>
